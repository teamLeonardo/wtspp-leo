...
const ItemTemplate = ({ info }) => {
    const [removeInfo, selectEditInfo] = useTempalteAddStore((state) => [state.removeInfo, state.selectEditInfo])
...
export const Template = () => {
    ...
    const [selectEditInfo] = useTempalteAddStore((state) => [state.selectEditInfo])
    const history = useNavigate();
    useEffect(() => {
        return () => {
            scrollUp()
